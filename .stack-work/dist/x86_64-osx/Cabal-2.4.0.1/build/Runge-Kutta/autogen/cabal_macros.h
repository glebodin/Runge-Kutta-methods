...
/* package Runge-Kutta-0.1.0.0 */
#ifndef VERSION_Runge_Kutta
#define VERSION_Runge_Kutta "0.1.0.0"
#endif /* VERSION_Runge_Kutta */
#ifndef MIN_VERSION_Runge_Kutta
#define MIN_VERSION_Runge_Kutta(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Runge_Kutta */
...
#define CURRENT_COMPONENT_ID "Runge-Kutta-0.1.0.0-Cuuy0JX0hZ7CfPJhHT4L31-Runge-Kutta"
